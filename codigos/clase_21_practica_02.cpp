...
int main(int argc, char *argv[]){
    Node<int> *root = NULL;
    int pre[] = {63,9};// supongamos que este es su preorden
    ...
    std::cout << "Insertamos valor 19"<< std::endl;
    root = Insert<int>(root, 19);
    ComputeHeight(root);
    PreOrderWithHeight(root);
    std::cout << std::endl;
    PreOrderWithFactor(root);
    ...
    std::cout << "Buscamos el nodo critido nodo->63 y rotamos a la izquierda el nodo hijo izquierdo,"<< std::endl;
    std::cout << "Posteriormente rotamos a la derecha."<< std::endl;
    Node<int> *z_father;
    Node<int> *z = Search(root,63, z_father);
    ...
    PreOrderWithFactor(root);
    std::cout << std::endl;
    std::cout << "Insertamos el resto de los elementos" << z->data << std::endl;
    root = Insert<int>(root, 27);
    root = Insert<int>(root, 18);
    root = Insert<int>(root, 108);
    root = Insert<int>(root, 99);
    root = Insert<int>(root, 103);
    ComputeHeight(root);
    PreOrderWithHeight(root);
    std::cout << std::endl;
    PreOrderWithFactor(root);
